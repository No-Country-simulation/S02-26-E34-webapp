                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                    ...
                    <div className="md:col-span-1">
                        <Link href="/" className="flex items-center gap-3 mb-6">
                            ...
                            <span className="text-xl font-bold tracking-tight text-white">Verv.io</span>
                        </Link>
                    ...
                    {/* Product Section */}
                    <div>
                        <h4 className="text-white font-bold mb-4 uppercase text-xs tracking-widest">Herramientas</h4>
                        <ul className="space-y-3">
                            <li><Link href="/editor" className="text-sm text-slate-400 hover:text-white transition-colors">Editor de Video</Link></li>
                            <li><button onClick={() => setActiveModal('cookies')} className="text-sm text-slate-400 hover:text-white transition-colors">Configurar Cookies</button></li>
                        </ul>
                    </div>

                    {/* Legal Section */}
                    <div>
                        <h4 className="text-white font-bold mb-4 uppercase text-xs tracking-widest">Compañía</h4>
                        <ul className="space-y-3">
                            <li><button onClick={() => setActiveModal('privacy')} className="text-sm text-slate-400 hover:text-white transition-colors">Política de Privacidad</button></li>
                            <li><button onClick={() => setActiveModal('terms')} className="text-sm text-slate-400 hover:text-white transition-colors">Términos de Servicio</button></li>
                            <li><button onClick={() => setActiveModal('contact')} className="text-sm text-slate-400 hover:text-white transition-colors">Contacto</button></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="p-4 bg-white/2 rounded-xl border border-white/5">
                            ...
                            <button
                                ...
                                className="flex items-center gap-2 text-xs font-bold text-white bg-[#3b2bee]/20 px-4 py-2 rounded-lg border border-[#3b2bee]/30 hover:bg-[#3b2bee]/30 transition-all w-full justify-center"
                            >
