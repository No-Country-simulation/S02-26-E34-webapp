...
const Modal = ({ isOpen, onClose, title, icon, children, footer }: ModalProps) => {
    ...
    return (
        <div className="fixed inset-0 z-100 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-200">
            <div
                className="w-full max-w-2xl bg-card border border-border rounded-2xl shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200"
            ...
            >
                <div className="flex items-center justify-between p-6 border-b border-white/5">
                    ...
                    <button
                        onClick={onClose}
                        className="p-2 text-slate-400 hover:text-foreground hover:bg-foreground/5 rounded-full transition-colors"
                    >
                        <X className="w-6 h-6" />
                    </button>
                </div>
...
export const LegalModals = ({
    ...
    return (
        <>
            ...
            >
                <h3 className="text-foreground font-bold text-lg mb-2">1. Recopilación de Información</h3>
                ...
                <h3 className="text-foreground font-bold text-lg mb-2">2. Uso de Datos</h3>
                ...
                <h3 className="text-foreground font-bold text-lg mb-2">3. Retención de Archivos</h3>
            ...
            >
                <h3 className="text-foreground font-bold text-lg mb-2">1. Uso del Servicio</h3>
                <p>Al utilizar Verv.io, aceptas no subir contenido que infrinja derechos de autor, sea ilegal, ofensivo o contenga malware.</p>

                <h3 className="text-foreground font-bold text-lg mb-2">2. Propiedad Intelectual</h3>
                ...
                <h3 className="text-foreground font-bold text-lg mb-2">3. Limitación de Responsabilidad</h3>
                ...
                footer={
                    <div className="flex flex-col sm:flex-row gap-3 w-full justify-end">
                        <button
                            ...
                            className="px-4 py-2 border border-border hover:bg-foreground/5 text-slate-300 hover:text-foreground text-sm font-semibold rounded-full transition-colors"
                        >
                            Rechazar no esenciales
                        </button>
                        <button
                            onClick={acceptAll}
                            className="px-4 py-2 bg-white/10 hover:bg-white/15 text-foreground text-sm font-semibold rounded-full transition-colors"
                        >
                            Aceptar todas
                        </button>
                        <button
            ...
            >
                ...
                <div className="space-y-4">
                    <div className="flex items-center justify-between gap-4 p-4 bg-foreground/5 rounded-xl border border-border">
                        <div>
                            <p className="text-foreground font-semibold">Necesarias</p>
                    ...
                    <button
                        ...
                        className="w-full flex items-center justify-between gap-4 p-4 bg-foreground/5 rounded-xl border border-border hover:border-white/20 transition-colors"
                    >
                        <div className="text-left">
                            <p className="text-foreground font-semibold">Preferencias</p>
                            <p className="text-sm text-slate-400">Recuerdan ajustes y preferencias visuales.</p>
                        </div>
                        <span className={`px-3 py-1 text-xs font-bold uppercase tracking-widest rounded-full ${cookiePrefs.preferences ? 'bg-[#3b2bee]/20 text-[#b9b3ff] border border-[#3b2bee]/40' : 'bg-foreground/5 text-slate-500 border border-border'}`}>
                    ...
                    >
                        <div className="text-left">
                            <p className="text-foreground font-semibold">Analiticas</p>
                            <p className="text-sm text-slate-400">Nos ayudan a mejorar el producto.</p>
                        </div>
                        <span className={`px-3 py-1 text-xs font-bold uppercase tracking-widest rounded-full ${cookiePrefs.analytics ? 'bg-[#3b2bee]/20 text-[#b9b3ff] border border-[#3b2bee]/40' : 'bg-foreground/5 text-slate-500 border border-border'}`}>
                    ...
                    >
                        ...
                        <span className={`px-3 py-1 text-xs font-bold uppercase tracking-widest rounded-full ${cookiePrefs.marketing ? 'bg-[#3b2bee]/20 text-[#b9b3ff] border border-[#3b2bee]/40' : 'bg-foreground/5 text-slate-500 border border-border'}`}>
            ...
            >
                ...
                <div className="p-4 bg-foreground/5 rounded-xl border border-border space-y-3">
                    <div className="flex items-center gap-3">
                        <Mail className="w-5 h-5 text-[#3b2bee]" />
                        <span className="text-foreground">soporte@verv.io</span>
                    </div>
                    <div className="flex items-center gap-3">
                        <Mail className="w-5 h-5 text-[#3b2bee]" />
                        <span className="text-foreground">info@verv.io</span>
                    </div>
                </div>
